...
2. Set the experiment start date.
3. Use the `Daily Entry` tab on phone or desktop.
4. Review outcomes in the `Dashboard` tab.
5. Export JSON regularly if you want versioned backups in GitHub.
